...
function DadosEntrega ({aoEnviar}) {
    ...
    return (
        ...
        <form onSubmit={(event) => {
            ...
            value={endereco} onChange={(event) => {
                setEndereco(event.target.value)
            }}
            />

            <TextField id="numero" label="Numero" type="number" variant='outlined' margin='normal' 
            value={numero} onChange={(event) => {
                setNumero(event.target.value)
            }}
            />

            <TextField id="estado" label="Estado" type="text" variant='outlined' margin='normal'
            value={estado} onChange={(event) => {
                setEstado(event.target.value)
            }}
            />

            <TextField id="cidade" label="Cidade" type="text" variant='outlined' margin='normal' fullWidth
            value={cidade} onChange={(event) => {
                setCidade(event.target.value)
            }}
            />

            <Button type="submit" color="primary" variant="contained"> Finalizar Cadastro. </Button>
